...
export function DisclosureSupplement({ onBack, onNext }: DisclosureSupplementProps) {
  ...
  const [editableContents, setEditableContents] = useState<Record<string, string>>({
    ...
    "technical-background": "智能家居作为物联网技术的重要应用场景，近年来发展迅速。传统的智能家居控制方式包括：\n\n1. 手机APP控制\n2. 物理按键控制\n3. 红外遥控器控制\n4. 简单语音指令控制\n\n这些控制方式各有局限性，无法满足用户对便捷性和智能化的需求。",
    "existing-defects": "现有技术存在以下缺点：\n\n1. 手机APP控制需要解锁手机、打开APP，操作步骤多\n2. 物理按键控制无法实现远程操作\n3. 红外遥控器存在方向性限制\n4. 简单语音控制无法理解复杂指令，且识别率受环境噪音影响大",
    "invention-purpose": "本发明的目的在于提供一种基于深度学习的智能家居控制系统，以解决现有技术中存在的响应延迟高、联动控制复杂、语音识别准确率低等问题。",
    "technical-solution": "",
    "key-points": "",
    "beneficial-effects": "",
    "actual-product": "",
